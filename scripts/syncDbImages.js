...
const Category = require('../server/src/modules/categories/category.model');
const Condition = require('../server/src/modules/conditions/condition.model');
...
async function syncImages() {
  ...
  for (const cat of categories) {
    ...
    cat.imageUrl = `/images/categories/${slug}.jpg`;
    await cat.save();
  ...
  for (const cond of conditions) {
    ...
    cond.imageUrl = `/images/conditions/${slug}.jpg`;
    await cond.save();
